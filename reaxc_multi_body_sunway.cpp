                  ...
                  output_controls *out_control )
{
  ...
  GPTLstart("reaxc atom energy and bonds c");
  Atom_Energy_C(&param);
  GPTLstop("reaxc atom energy and bonds c");
        ...
        if( !strcmp( system->reax_param.sbp[type_j].name, "C" ) ) 
        {
          ...
          if( vov3 > 3. ) 
          {
            ...
            if( system->pair_ptr->evflag)
            {
              ...
              system->pair_ptr->eng_vdwl += e_lph;
            }
