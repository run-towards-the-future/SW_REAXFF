...
extern "C"{
    extern void Valence_Angles_C(void *param);
    extern void Valence_Angles_C_part_init(void *param);
    //extern void Valence_Angles_C_part_pack(void *param);
    extern void Valence_Angles_C_part_compute(void *param);
    //extern void Valence_Angles_C_part_reduce(void *param);

    //extern void Valence_Angles_C(reax_system_c *, control_params *, simulation_data *,
    //                             storage *, reax_list**);
  }
                     ...
                     reax_list **lists, output_controls *out_control )
{
  ...
  //Valence_Angles_C(&csys, control, data, workspace, lists);
...
//  //param.vpk_in      = vpk_in;
//  //param.vpk_out     = vpk_out;
//
//  GPTLstart("reaxc valence angles c");
//
//  GPTLstart("reaxc valence angles c init");
//  Valence_Angles_C_part_init(&param);   //////
//  GPTLstop("reaxc valence angles c init");
//  
//  //GPTLstart("reaxc valence angles c pack");
//  //Valence_Angles_C_part_pack(&param);   //////
//  //GPTLstop("reaxc valence angles c pack");
//
//  GPTLstart("reaxc valence angles c compute");
//  Valence_Angles_C_part_compute(&param);//////
//  GPTLstop("reaxc valence angles c compute");
//
//  ////GPTLstart("reaxc valence angles c reduce");
//  ////Valence_Angles_C_part_reduce(&param);//////
//  ////GPTLstop("reaxc valence angles c reduce");
//
//  //Valence_Angles_C(&param);
//
//  GPTLstop("reaxc valence angles c");
//
